...
class MainService:
      ...
      while not self.kodimonitor.abortRequested() and xbmc.getCondVisibility("!String.IsEmpty(Window(home).Property(IconMixToolsbackend))"): 
          ...
          if xbmc.getCondVisibility("Player.HasAudio"):
              ...
              if self.windowmusicvisID and not str(self.selecteditemAlbumPlayer)=="" and (self.previousitemPlayer != self.selecteditemAlbumPlayer or (self.windowmusicvisID and self.PreviousWindowActiveID!=self.windowmusicvisID)):
                ...
                if self.windowmusicvis: 
                  ListeFanarts=self.MonGetControl(self.windowmusicvis,2996)
          ...
          if xbmc.getCondVisibility("Window.IsVisible(10502)"):
            ...
            if self.selecteditemMusic>-1 and not str(self.selecteditemMusic)=="" and self.previousitemMusic != self.selecteditemMusic:
              ...
              ListeSaga=self.MonGetControl(self.windowmusicnav,1999)
              ListeFanarts=self.MonGetControl(self.windowmusicnav,2995)
          ...
          if IconmixShowInfo=="1" or IconmixShowInfo=="2" :
            ...
            if ItemListe:
                  ListeActeursInf=[]
                  if IconmixShowInfo=="1":
                    ListeActeurs=self.MonGetControl(self.windowvideonav,1998)
                    if ListeActeurs:
                  ...
                  if MiseAjour!="" : #liste des acteurs
                      ...
                      if xbmc.getCondVisibility("Control.HasFocus(2999)"):
                        ...
                        if (self.selecteditem > -1 and not str(self.selecteditem)==""): 
                            ...
                            if MiseAjour=="2":
                               #ACTEURS VIDEOINFO
                               ListeActeurs=self.MonGetControl(self.windowvideoinf,1998)
                               #ListeActeursInf=self.MonGetControl(self.windowvideoinf,5007)
                               
                            if MiseAjour=="3":
                               #ACTEURS VideoPlayer
                               try:
                                  ListeActeurs=self.MonGetControl(self.windowvideoplayer,1998)
                               except:
                                  ListeActeurs=None
                            if MiseAjour=="4":
                               #ACTEURS VideoPlayer
                               try:
                                 ListeActeurs=self.MonGetControl(self.windowvideoplayerinfo,1998)
                               except:
                                 ListeActeurs=None
                            ...
                            if not xbmc.getCondVisibility("Window.IsVisible(12901)") and not xbmc.getCondVisibility("Window.IsVisible(10142)") : #pas en lecture visible
                                if (self.DBTYPE=="set" or MiseAjour=="2") : #mise à jour saga (videonav ou videoinfo)
                                  if not MiseAjour=="2":
                                     ListeSaga=self.MonGetControl(self.windowvideonav,1999)
                                     ListeFanarts=self.MonGetControl(self.windowvideonav,5555)  
                                     SetID=self.selecteditem
                                  else:
                                     ListeSaga=self.MonGetControl(self.windowvideoinf,5002)
                                     ListeFanarts=None
                                ...
                                if self.DBTYPEOK or self.DBTYPE=="tvshow":
                                   ...
                                   if self.DBTYPE!="tvshow":                                    
                                    ...
                                    """
                                    ListeEpisodes=self.MonGetControl(self.windowvideonav,1999)
                                ...
                                if (self.DBTYPE=="director" or self.DBTYPE=="actor"):
                                  ...
                                  ListeFilmographie=self.MonGetControl(self.windowvideonav,1999)
    ...
    def MonGetControl(self,Window=None,Id=None,IdWin=none):
          ControlId=None   
          if IdWin:
            try:
              Window=xbmcgui.Window(IdWin)
            except:
              Window=None
          if Window:       
            try:
              ...
              if (self.previousitem1998 != self.selecteditem1998 and not str(self.selecteditem1998)=="") or ( self.previousitem1998local!=KodiLocal) or (IconmixShowInfo and self.selecteditem1998) :
                if not IconmixShowInfo:
                  ...
                  if xbmc.getCondVisibility("Window.IsVisible(10025)"):
                     #ACTEURS VIDEONAV
                     ListeRole=self.MonGetControl(self.windowvideonav,5051)
                     
                  if xbmc.getCondVisibility("Window.IsVisible(12003)"):
                     #ACTEURS VIDEOINFO
                     if not F7777:
                      ListeRole=self.MonGetControl(self.windowvideoinf,5051)
                     else:
                      ListeRole=self.MonGetControl(self.windowvideoinf,5052)
                     
                  if xbmc.getCondVisibility("Window.IsVisible(12901)"):
                     #ACTEURS VideoPlayer
                     try:
                       ListeRole=self.MonGetControl(self.windowvideoplayer,5051)
                     except:
                       ListeRole=None
                  ...
                  if xbmc.getCondVisibility("Window.IsVisible(10142)"):
                     ...
                     try:
                      ListeRole=self.MonGetControl(self.windowvideoplayerinfo,5051)
                     except:
                      ListeRole=None
                else:
                  try:
                  ...
                  if win:
                    if not F7777:
                      ListeRole=self.MonGetControl(win,5051)
                    else:
                      ListeRole=self.MonGetControl(win,5052)
